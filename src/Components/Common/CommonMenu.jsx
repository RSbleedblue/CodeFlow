        ...
        <>
            <div className="w-[15%]  p-2 flex flex-col items-center rounded-2xl bg-black  border border-gray-900 shadow-xl h-screen gap-4 justify-between">
                ...
                <div className="flex flex-col items-center w-full">
                    ...
                    <p className="text-gray-500 flex items-center gap-2 p-2 border-l-2 border-gray-400 border-opacity-0 hover:border-codeFlow w-full hover:text-codeFlow cursor-pointer transition-all"><span className=" text-xl"><FaSearch/></span>Search Flows</p>
                </div>
