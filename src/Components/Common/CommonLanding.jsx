            ...
            <div className="w-full h-full bg-black border border-gray-900 rounded-lg flex relative">
                <div className="flex flex-col p-10 w-[50%] gap-10">
                    <div className=" flex  gap-5">
                        ...
                        <p className="text-gray-100 text-3xl font-semibold w-[60%] text-sans ">Dive into front-end development's ultimate playground for building, testing, and discovering code.</p>
                    </div>
                    <div>
                ...
                <img className="absolute w-[450px] right-0 top-0 z-0 opacity-80" src="https://cpwebassets.codepen.io/assets/packs/lines-2-4e66616a5ef291c3566a7ddfe1ffaaa8.svg"></img>
            </div>
        </>
    )
}
